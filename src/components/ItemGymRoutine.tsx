...
export default function ItemGymRoutine({ image, exercise, description, sets, reps }: Item) {
    return (
        <div className="w-full col-span-full xl:col-span-1 bg-[#aad7b8] flex justify-between items-center border-3 rounded-xl py-1 px-2 shadow-[0px_5px_0px_0px_#000000]">
